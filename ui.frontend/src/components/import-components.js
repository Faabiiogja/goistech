...
MapTo('goistech/components/download')(DownloadV1, {isEmpty: DownloadV1IsEmptyFn});
MapTo('goistech/components/list')(ListV2, {isEmpty: ListV2IsEmptyFn});
MapTo('goistech/components/separator')(SeparatorV1, {isEmpty: SeparatorV1IsEmptyFn});

MapTo('goistech/components/button')(ButtonV1, {isEmpty: ButtonV1IsEmptyFn});
MapTo('goistech/components/teaser')(TeaserV1, {isEmpty: TeaserV1IsEmptyFn});
MapTo('goistech/components/image')(ImageV2, {isEmpty: ImageV2IsEmptyFn});
MapTo('goistech/components/title')(TitleV2, {isEmpty: TitleV2IsEmptyFn});


MapTo('goistech/components/breadcrumb')(BreadCrumbV2, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('goistech/components/navigation')(NavigationV1);
MapTo('goistech/components/languagenavigation')(LanguageNavigationV1);


MapTo('goistech/components/tabs')(TabsV1, {isEmpty: TabsV1IsEmptyFn});
MapTo('goistech/components/accordion')(AccordionV1, {isEmpty: AccordionV1IsEmptyFn});
MapTo('goistech/components/carousel')(CarouselV1, {isEmpty: CarouselV1IsEmptyFn});
MapTo('goistech/components/container')(ContainerV1, {isEmpty: ContainerV1IsEmptyFn});
